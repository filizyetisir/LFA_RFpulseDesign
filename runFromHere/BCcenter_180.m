function BCcenter_180(verse_factor, display, spokesdefpath, use_fixed_subpulse,data, gDown, tp)
%function BCcenter_180(verse_factor, display, spokesdefpath, use_fixed_subpulse)
...
avg_target = 0;   % for BC pulse, make 1 if you want the average to be the target, 0 if you want the center of the image to be target: scaling of the pulse
