function BCcenter_90(verse_factor, display, spokesdefpath, use_fixed_subpulse,data, gDown, tp)
%function BCcenter_90(verse_factor, display, spokesdefpath,use_fixed_subpulse)
